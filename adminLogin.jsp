	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="blood.controller.AdminLogin" method="post">
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						...
						<div>
							<a href="adminForgotPassword.jsp" class="txt1">
								Forgot Password?
							</a>
						</div>
					</div>
				...
				<div class="login100-more" style="background-image: url('images/r1.jpg');">
				</div>
			</div>
		</div>
	</div>
