		...
		<div class="container">
			<div class="wthree-header">
				<div class="agileits-logo navbar-left">
					<h1 class="wow swing animated" data-wow-delay=".5s"><a href="index.jsp">Lifeline</a></h1>
				</div>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-center w3l-effect" >
							...
							<li><a href="blood.controller.AdminLogout" >Logout</a></li>
							<li><a href="viewContact.jsp" >Contact</a></li>
						</ul>	
						<div class="clearfix"> </div>
					</div>	
				</nav>		
